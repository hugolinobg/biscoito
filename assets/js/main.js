...
const phrase = document.querySelector(".luckyPhrase")
...
function generatePhrase() {
  ...
  const randomPhrase = Math.floor(Math.random() * luckyPhrase.length)

  phrase.textContent = luckyPhrase[randomPhrase]
